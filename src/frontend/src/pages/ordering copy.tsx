                ...
                .request({
                  ...
                  data: JSON.stringify({
                    ...
                    messages: [
                      ...
                      {
                        role: "user",
                        content: `CONDITIONS: [Meal Time=${values.mealTime}, Cuisine Preference=${values.cuisinePreference}, Spiciness Level=${values.spiciness}, Dietary Restrictions=${values.restriction}, Allergies=${values.allergies}]`,
                      },
                    ],
                    temperature: 0.7,
                    max_tokens: -1,
